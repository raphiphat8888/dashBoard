...
export const Header: React.FC<HeaderProps> = ({ searchTerm, onSearchChange, onSearchSubmit }) => {
    ...
    <header className="h-16 border-b border-zinc-800/50 bg-zinc-950/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 bg-zinc-900 border border-zinc-800 rounded-full text-zinc-300 hover:text-emerald-500 hover:border-emerald-500/50 transition-all text-xs font-bold tracking-wider"
        >
          <Languages size={14} />
